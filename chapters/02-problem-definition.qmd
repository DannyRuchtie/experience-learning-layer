...
![**Six tests for a useful concept.** Grounding and generality are necessary but insufficient: a durable concept must also declare scope, remain revisable, affect action, and support independent measurement.](assets/visuals/useful-concept.png){#fig-useful-concept fig-alt="Six concept tests: grounded, general, scoped, revisable, actionable, and measurable." width="100%"}

## Failure modes addressed

![**Memory can appear capable without learning.** These failure modes motivate the separation of episodes, reflections, concepts, evidence, and outcomes.](assets/visuals/failure-modes.png){#fig-failure-modes fig-alt="Seven failure modes include replay without abstraction, overgeneralisation, self-confirmation, context loss, staleness, provenance loss, and unmeasured learning claims." width="100%"}
...
![**The claim hierarchy prevents scope drift.** Transfer is primary, unsupported generalisation is a mandatory guardrail, revision and efficiency are mechanisms, intuition quality is exploratory, and self-scaffolding is a separate follow-on claim.](assets/visuals/claim-hierarchy.png){#fig-claim-hierarchy fig-alt="A tiered hierarchy places transfer at the top, followed by safety, mechanisms, exploratory product outcomes, and separate self-scaffolding research." width="100%"}
