# Deferred Experience Learning Layer Expansion
...
![**Memory is plural, not one untyped table.** Source, working, episodic, semantic, preference, procedural, prospective, relational, reflective, and policy memory require different authority, lifetime, and retrieval rules.](assets/visuals/memory-semantics.png){#fig-memory-semantics fig-alt="Ten cards distinguish source, working, episodic, semantic, preference, procedural, prospective, relational, reflective, and policy memory." width="100%"}
...
![**Provider connectors end at a stable normalisation boundary.** Chats, tool traces, documents, and calendars become immutable source artifacts, typed experience events, and time-bounded episodes with deterministic identifiers.](assets/visuals/source-event-episode.png){#fig-source-event-episode fig-alt="Four connector sources converge on a source artifact, then experience events, then a bounded episode." width="100%"}
