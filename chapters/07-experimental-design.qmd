...
![**Evaluation widens only after controlled evidence is earned.** Stage A carries the confirmatory transfer claim; Stages B-D broaden the task setting; Stage E is a separately gated self-scaffolding study.](assets/visuals/evaluation-stages.png){#fig-evaluation-stages fig-alt="A staircase moves from controlled latent-pattern streams through conversations, action, intuition, and finally self-scaffolding." width="100%"}
...
### Stage E: governed self-scaffolding
...
![**The simulation lab makes hidden choices visible.** Stream size, noise, change points, permissions, and delayed outcomes feed paired baseline and ELL conditions with matched budgets and complete transfer, safety, adaptation, evidence, and cost readouts.](assets/visuals/simulation-lab.png){#fig-simulation-lab fig-alt="Visible simulation controls feed paired baseline and ELL conditions and produce transfer, safety, adaptation, evidence, and cost readouts." width="100%"}
...
![**Parallel baseline lanes.** No-memory, maximum-context, retrieval, summary, direct-insight, agent-controlled, and ELL-Core conditions receive the same chronological stream and model conditions before sealed evaluation.](assets/visuals/baseline-lanes.png){#fig-baseline-lanes fig-alt="Seven parallel baseline lanes receive the same inputs and end at sealed evaluation." width="100%"}
...
![**A transfer gain is only one tile in the decision dashboard.** Scope safety, evidence, adaptation, efficiency, governance, and replication remain mandatory rather than optional diagnostics.](assets/visuals/metrics-dashboard.png){#fig-metrics-dashboard fig-alt="Six metric cards show transfer, scope safety, evidence, adaptation, efficiency, and governance thresholds." width="100%"}
...
![**Ablations diagnose which mechanism earned the result.** Removing critique, counterevidence, temporal validity, outcomes, or scope shows how each component affects transfer, overgeneralisation, adaptation, evidence quality, and cost.](assets/visuals/ablation-grid.png){#fig-ablation-grid fig-alt="A grid compares full ELL with component removals across transfer, overgeneralisation, adaptation, evidence, and cost." width="100%"}
...
![**The confirmatory analysis is a sealed, paired sequence.** Matched tasks produce an absolute effect estimate and uncertainty interval, followed by mandatory gate checks and a preregistered outcome label.](assets/visuals/analysis-plan.png){#fig-analysis-plan fig-alt="A five-stage analysis moves from paired tasks to effect estimate, uncertainty, gate checks, and outcome label." width="100%"}
